...
public class RowNumHandle {
    ...
    public RowNumHandle(boolean hasRowNumEquals, boolean hasRowNumRange, long minRowNum, long maxRowNum, long size, long page, long offset) {
    ...
    public static RowNumHandle getSimpleHandle(int page, int size){
        return new RowNumHandle(
                false,
                false,
                1,
                Long.MAX_VALUE,
