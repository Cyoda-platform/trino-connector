...
package com.cyoda.core.reports;
...
// TODO: We need to bundle all the non-connector com.cyoda classes that were copied from the platform
// into a dependency that we can use in connector-cyoda connector.
// These need to introduce an absolute minimum of transitive dependencies to connector.
@BeanDefinition(constructorScope = "public@ConstructorProperties")
public final class DistributedReportInfoDto implements ImmutableBean {
    ...
    @JsonProperty
    @PropertyDefinition
    public final boolean reportFailed;

    @JsonProperty
    @PropertyDefinition
    public final boolean secondPhaseFinished;
    ...
    @JsonProperty
    @PropertyDefinition
    public final long totalRowsCount;

    @JsonProperty
    @PropertyDefinition
    public final boolean markedAsCancelled;

    @JsonProperty
    @PropertyDefinition
    public final Map<String, Integer> rowsCountForFinishedShards;

    @JsonProperty
    @PropertyDefinition
    public final Map<String, String> reportFailedShards;
    ...
    @JsonProperty
    @PropertyDefinition
    public final String gridConfigId;

    @JsonProperty
    @PropertyDefinition
    public final Long version; //timestamp of report

    @JsonProperty
    @PropertyDefinition
    public final Date pointTime;

    @JsonProperty
    @PropertyDefinition
    public final Date valuationPointTime;
    ...
    @JsonProperty
    @PropertyDefinition
    public final boolean regroupingPossible;

    @JsonProperty
    @PropertyDefinition
    public final List<String> groupingCols;


    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code DistributedReportInfoDto}.
     * @return the meta-bean, not null
     */
    public static DistributedReportInfoDto.Meta meta() {
        return DistributedReportInfoDto.Meta.INSTANCE;
    }

    static {
        MetaBean.register(DistributedReportInfoDto.Meta.INSTANCE);
    }
     ...
     */
    public static DistributedReportInfoDto.Builder builder() {
        return new DistributedReportInfoDto.Builder();
    }
     ...
     * @param secondPhaseFinished  the value of the property
     * @param groupsCount  the value of the property
     * @param totalRowsCount  the value of the property
     * @param markedAsCancelled  the value of the property
     * @param rowsCountForFinishedShards  the value of the property
     * @param reportFailedShards  the value of the property
     * @param userName  the value of the property
     * @param userId  the value of the property
     * @param configName  the value of the property
     * @param gridConfigId  the value of the property
     * @param version  the value of the property
     * @param pointTime  the value of the property
     * @param valuationPointTime  the value of the property
     * @param description  the value of the property
     * @param groupingVersion  the value of the property
     * @param hierarchy  the value of the property
     * @param regroupingPossible  the value of the property
     * @param groupingCols  the value of the property
     */
    @ConstructorProperties({"id", "createTime", "finishTime", "reportFailed", "secondPhaseFinished", "groupsCount", "totalRowsCount", "markedAsCancelled", "rowsCountForFinishedShards", "reportFailedShards", "userName", "userId", "configName", "gridConfigId", "version", "pointTime", "valuationPointTime", "description", "groupingVersion", "hierarchy", "regroupingPossible", "groupingCols"})
    public DistributedReportInfoDto(
            String id,
            Date createTime,
            Date finishTime,
            boolean reportFailed,
            boolean secondPhaseFinished,
            int groupsCount,
            long totalRowsCount,
            boolean markedAsCancelled,
            Map<String, Integer> rowsCountForFinishedShards,
            Map<String, String> reportFailedShards,
            String userName,
            UUID userId,
            String configName,
            String gridConfigId,
        ...
        this.rowsCountForFinishedShards = (rowsCountForFinishedShards != null ? ImmutableMap.copyOf(rowsCountForFinishedShards) : null);
        this.reportFailedShards = (reportFailedShards != null ? ImmutableMap.copyOf(reportFailedShards) : null);
        this.userName = userName;
        this.userId = userId;
        this.configName = configName;
        this.gridConfigId = gridConfigId;
        this.version = version;
        this.pointTime = (pointTime != null ? (Date) pointTime.clone() : null);
        this.valuationPointTime = (valuationPointTime != null ? (Date) valuationPointTime.clone() : null);
    ...
    @Override
    public DistributedReportInfoDto.Meta metaBean() {
        return DistributedReportInfoDto.Meta.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            DistributedReportInfoDto other = (DistributedReportInfoDto) obj;
    ...
    public String toString() {
        ...
        buf.append("DistributedReportInfoDto{");
        ...
        buf.append("groupingCols").append('=').append(JodaBeanUtils.toString(groupingCols));
        buf.append('}');
        return buf.toString();
    }
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> id = DirectMetaProperty.ofImmutable(
                this, "id", DistributedReportInfoDto.class, String.class);
        /**
        ...
        private final MetaProperty<Date> createTime = DirectMetaProperty.ofImmutable(
                this, "createTime", DistributedReportInfoDto.class, Date.class);
        /**
        ...
        private final MetaProperty<Date> finishTime = DirectMetaProperty.ofImmutable(
                this, "finishTime", DistributedReportInfoDto.class, Date.class);
        /**
        ...
        private final MetaProperty<Boolean> reportFailed = DirectMetaProperty.ofImmutable(
                this, "reportFailed", DistributedReportInfoDto.class, Boolean.TYPE);
        /**
        ...
        private final MetaProperty<Boolean> secondPhaseFinished = DirectMetaProperty.ofImmutable(
                this, "secondPhaseFinished", DistributedReportInfoDto.class, Boolean.TYPE);
        /**
        ...
        private final MetaProperty<Integer> groupsCount = DirectMetaProperty.ofImmutable(
                this, "groupsCount", DistributedReportInfoDto.class, Integer.TYPE);
        /**
        ...
        private final MetaProperty<Long> totalRowsCount = DirectMetaProperty.ofImmutable(
                this, "totalRowsCount", DistributedReportInfoDto.class, Long.TYPE);
        /**
        ...
        private final MetaProperty<Boolean> markedAsCancelled = DirectMetaProperty.ofImmutable(
                this, "markedAsCancelled", DistributedReportInfoDto.class, Boolean.TYPE);
        /**
        ...
        private final MetaProperty<Map<String, Integer>> rowsCountForFinishedShards = DirectMetaProperty.ofImmutable(
                this, "rowsCountForFinishedShards", DistributedReportInfoDto.class, (Class) Map.class);
        /**
        ...
        private final MetaProperty<Map<String, String>> reportFailedShards = DirectMetaProperty.ofImmutable(
                this, "reportFailedShards", DistributedReportInfoDto.class, (Class) Map.class);
        /**
        ...
        private final MetaProperty<String> configName = DirectMetaProperty.ofImmutable(
                this, "configName", DistributedReportInfoDto.class, String.class);
        /**
        ...
        private final MetaProperty<Date> pointTime = DirectMetaProperty.ofImmutable(
                this, "pointTime", DistributedReportInfoDto.class, Date.class);
        /**
        ...
        private final MetaProperty<Date> valuationPointTime = DirectMetaProperty.ofImmutable(
                this, "valuationPointTime", DistributedReportInfoDto.class, Date.class);
        /**
        ...
        private final MetaProperty<String> description = DirectMetaProperty.ofImmutable(
                this, "description", DistributedReportInfoDto.class, String.class);
        /**
        ...
        private final MetaProperty<UUID> groupingVersion = DirectMetaProperty.ofImmutable(
                this, "groupingVersion", DistributedReportInfoDto.class, UUID.class);
        /**
        ...
        private final MetaProperty<Boolean> hierarchy = DirectMetaProperty.ofImmutable(
                this, "hierarchy", DistributedReportInfoDto.class, Boolean.TYPE);
        /**
        ...
        private final MetaProperty<Boolean> regroupingPossible = DirectMetaProperty.ofImmutable(
                this, "regroupingPossible", DistributedReportInfoDto.class, Boolean.TYPE);
        /**
         * The meta-property for the {@code groupingCols} property.
         */
        private final MetaProperty<List<String>> groupingCols = DirectMetaProperty.ofImmutable(
                this, "groupingCols", DistributedReportInfoDto.class, (Class)List.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public DistributedReportInfoDto.Builder builder() {
            return new DistributedReportInfoDto.Builder();
        }

        @Override
        public Class<? extends DistributedReportInfoDto> beanType() {
            return DistributedReportInfoDto.class;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Date> createTime() {
            return createTime;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Date> finishTime() {
            return finishTime;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> reportFailed() {
            return reportFailed;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> secondPhaseFinished() {
            return secondPhaseFinished;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Integer> groupsCount() {
            return groupsCount;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Long> totalRowsCount() {
            return totalRowsCount;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> markedAsCancelled() {
            return markedAsCancelled;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Map<String, Integer>> rowsCountForFinishedShards() {
            return rowsCountForFinishedShards;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Map<String, String>> reportFailedShards() {
            return reportFailedShards;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<UUID> userId() {
            return userId;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<String> configName() {
            return configName;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<String> gridConfigId() {
            return gridConfigId;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Long> version() {
            return version;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<UUID> groupingVersion() {
            return groupingVersion;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> hierarchy() {
            return hierarchy;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> regroupingPossible() {
            return regroupingPossible;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<List<String>> groupingCols() {
            return groupingCols;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 3355:  // id
                    return ((DistributedReportInfoDto) bean).getId();
                case 1369213417:  // createTime
                    return ((DistributedReportInfoDto) bean).getCreateTime();
                case 1151521280:  // finishTime
                    return ((DistributedReportInfoDto) bean).getFinishTime();
                case 213393041:  // reportFailed
                    return ((DistributedReportInfoDto) bean).isReportFailed();
                case -211268871:  // secondPhaseFinished
                    return ((DistributedReportInfoDto) bean).isSecondPhaseFinished();
                case 1630112667:  // groupsCount
                    return ((DistributedReportInfoDto) bean).getGroupsCount();
                case -1591291950:  // totalRowsCount
                    return ((DistributedReportInfoDto) bean).getTotalRowsCount();
                case 1979766131:  // markedAsCancelled
                    return ((DistributedReportInfoDto) bean).isMarkedAsCancelled();
                case -1621482374:  // rowsCountForFinishedShards
                    return ((DistributedReportInfoDto) bean).getRowsCountForFinishedShards();
                case 664454726:  // reportFailedShards
                    return ((DistributedReportInfoDto) bean).getReportFailedShards();
                case -266666762:  // userName
                    return ((DistributedReportInfoDto) bean).getUserName();
                case -836030906:  // userId
                    return ((DistributedReportInfoDto) bean).getUserId();
                case 831324397:  // configName
                    return ((DistributedReportInfoDto) bean).getConfigName();
                case 1685196131:  // gridConfigId
                    return ((DistributedReportInfoDto) bean).getGridConfigId();
                case 351608024:  // version
                    return ((DistributedReportInfoDto) bean).getVersion();
                case 1564529789:  // pointTime
                    return ((DistributedReportInfoDto) bean).getPointTime();
                case -1843609732:  // valuationPointTime
                    return ((DistributedReportInfoDto) bean).getValuationPointTime();
                case -1724546052:  // description
                    return ((DistributedReportInfoDto) bean).getDescription();
                case -93847979:  // groupingVersion
                    return ((DistributedReportInfoDto) bean).getGroupingVersion();
                case 2115146293:  // hierarchy
                    return ((DistributedReportInfoDto) bean).isHierarchy();
                case 1375666119:  // regroupingPossible
                    return ((DistributedReportInfoDto) bean).isRegroupingPossible();
                case -69040490:  // groupingCols
                    return ((DistributedReportInfoDto) bean).getGroupingCols();
            }
    ...
    //-----------------------------------------------------------------------
    /**
     * The bean-builder for {@code DistributedReportInfoDto}.
     */
    public static final class Builder extends DirectFieldsBeanBuilder<DistributedReportInfoDto> {
         ...
         */
        private Builder(DistributedReportInfoDto beanToCopy) {
        ...
        public Builder set(String propertyName, Object newValue) {
            switch (propertyName.hashCode()) {
                ...
                case 1375666119:  // regroupingPossible
                    ...
                    break;
                case -69040490:  // groupingCols
                    this.groupingCols = (List<String>) newValue;
                    break;
                default:
                    throw new NoSuchElementException("Unknown property: " + propertyName);
            }
        ...
        @Override
        public DistributedReportInfoDto build() {
            return new DistributedReportInfoDto(
                    id,
                    createTime,
                    finishTime,
                    reportFailed,
         ...
         * @return this, for chaining, not null
         */
        public Builder groupingCols(List<String> groupingCols) {
            this.groupingCols = groupingCols;
            return this;
        }
        ...
        public String toString() {
            StringBuilder buf = new StringBuilder(736);
            buf.append("DistributedReportInfoDto.Builder{");
            buf.append("id").append('=').append(JodaBeanUtils.toString(id)).append(',').append(' ');
            buf.append("createTime").append('=').append(JodaBeanUtils.toString(createTime)).append(',').append(' ');
            buf.append("finishTime").append('=').append(JodaBeanUtils.toString(finishTime)).append(',').append(' ');
            buf.append("reportFailed").append('=').append(JodaBeanUtils.toString(reportFailed)).append(',').append(' ');
