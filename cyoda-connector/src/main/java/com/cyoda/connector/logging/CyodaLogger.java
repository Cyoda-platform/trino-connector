...
//COPY OF io.airlift.log.Logger;
//copied to add log handlers
...
public class CyodaLogger
{
    private final java.util.logging.Logger logger;

    private CyodaLogger(java.util.logging.Logger logger)
    {
        this.logger = requireNonNull(logger, "logger is null");
        logger.addHandler(LogRecordHandler.getInstance());
    }
     ...
     */
    public static CyodaLogger get(String name)
    {
        return new CyodaLogger(java.util.logging.Logger.getLogger(name));
    }
